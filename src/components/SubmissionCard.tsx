...
export interface SubmissionCardProps {
	/** The ID of the form */
	formId: string;
	/** Public URL identifier for public view (slug or token) */
	formUrl?: string;
...
const SubmissionCard: React.FC<SubmissionCardProps> = ({
	...
	const handleReview = () => {
		...
		// Navigate to internal review page
			...
			<div className="flex items-center gap-3">
				...
				{status === "published" && formUrl && (
					<button
						...
						className="inline-flex items-center gap-2 bg-[var(--color-black-900)] hover:bg-[var(--color-black-800)] text-white px-4 py-2 rounded-lg font-medium transition-colors"
					>
						<svg
							className="w-4 h-4"
							fill="none"
